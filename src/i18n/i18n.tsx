        ...
        translation: {
          description: {
            ...
            registration: {
              ...
              otherInformationText:
                'Personen, die unseren Service nutzen, haben möglicherweise deine Kontaktinformationen auf Facebook hochgeladen.',
              learnMore: ' Mehr dazu',
              agreementText:
                'Indem du auf „Registrieren“ klickst, stimmst du unseren Nutzungsbedingungen, unserer Datenrichtlinie und Cookie-Richtlinie zu. Wir schicken dir eventuell Benachrichtigungen per SMS, die du jederzeit abbestellen kannst.',
            },
            accountSearch: {
              accountSearchText:
                'Bitte gib deine E-Mail-Adresse oder Mobilnummer ein, um nach deinem Konto zu suchen.',
      ...
      ru: {
        translation: {
          description: {
            ...
            accountSearch: {
              accountSearchText:
                'Чтобы найти свой аккаунт, введите ваш электронный адрес или номер мобильного телефона',
            ...
            footer: {
              languages:
                'Русский  Беларуская  English (US)   العربية  Türkçe  Polski  Italiano  Tiếng Việt  Deutsch  Español  Português (Brasil)',
              links:
      ...
      br: {
        translation: {
          description: {
            authorization: {
              article:
                'Facebook дапамагае заставацца на сувязі і дзяліцца навінамі з людзьмі, якіх вы ведаеце.',
            ...
            registration: {
              ...
              learnMore: 'Learn more.',
              agreementText:
                ' By clicking Зарэгістравацца, you agree to our Terms, Privacy Policy and Cookies Policy. You may receive SMS Notifications from us and can opt out any time.',
            },
            accountSearch: {
              accountSearchText:
                'Калі ласка, увядзіце свой адрас электроннай пошты або нумар мабільнага тэлефона для пошуку вашай ўліковага запісу.',
        ...
        translation: {
          description: {
            ...
            registration: {
              ...
              otherInformationText:
                'Osoby korzystające z naszej usługi mogły przesłać Twoje dane kontaktowe do Facebooka.',
              learnMore: 'Dowiedz się więcej.',
              agreementText:
                'Klikając przycisk Zarejestruj się, akceptujesz nasz Regulamin, Zasady ochrony prywatności i Zasady dotyczące plików cookie. Możesz otrzymywać powiadomienia SMS z Facebooka, z których możesz zrezygnować w dowolnej chwili.',
            },
            accountSearch: {
              accountSearchText:
                'Wprowadź adres e-mail lub numer telefonu komórkowego, aby wyszukać swoje konto.',
      ...
      es: {
        translation: {
          description: {
            ...
            footer: {
              languages:
                'Español   Русский   Беларуская   English (US)   العربية   Türkçe   Polski   Italiano   Tiếng Việt   Deutsch   Português (Brasil)',
              links:
        ...
        translation: {
          description: {
            ...
            registration: {
              ...
              otherInformationText:
                'Le persone che usano il nostro servizio potrebbero aver caricato le tue informazioni di contatto su Facebook. ',
              learnMore: 'Scopri di più.',
              agreementText:
                "Cliccando su Iscriviti, accetti le nostre Condizioni, l'Informativa sulla privacy e la Normativa sui cookie. Potresti ricevere notifiche tramite SMS da noi, ma puoi disattivarle in qualsiasi momento.",
            },
            accountSearch: {
              accountSearchText:
                "Inserisci l'e-mail o il numero di cellulare per cercare il tuo accont.",
            ...
            footer: {
              languages:
                'Italiano   Русский   Беларуская   English (US)  العربية   Türkçe   Polski   Tiếng Việt   Deutsch   Español    Português (Brasil) ',
              links:
        ...
        translation: {
          description: {
            ...
            registration: {
              ...
              otherInformationText:
                'As pessoas que usam nosso serviço podem ter carregado suas informações de contato no Facebook.',
        ...
        translation: {
          description: {
            ...
            registration: {
              ...
              agreementText:
                'Kaydol düğmesine tıklayarak, Koşullarımızı, Gizlilik İlkemizi ve Çerezler İlkemizi kabul etmiş olursun. Bizden SMS Bildirimleri alabilir ve bu bildirimleri istediğin zaman durdurabilirsin.',
            },
            accountSearch: {
              accountSearchText:
          ...
          description: {
            ...
            registration: {
              ...
              dateOfBirth: {
                ...
                month: [
                  'Tháng một,Tháng Hai,Diễu hành,Tháng Tư,Có thể,Tháng Sáu,Tháng Bảy,Uy nghi,Tháng Chín,Tháng Mười,Tháng Mười Một,Tháng mười hai',
                ],
              },
              name: 'Họ',
              surname: 'Tên',
            ...
            footer: {
              languages:
                'Tiếng Việt   Русский    Беларуская   English (US)    العربية   Türkçe    Polski   Italiano    Deutsch   Español    Português (Brasil)',
              links:
